...
const EmailVerify = () => {
  ...
  return (
    <div  className='flex items-center justify-center min-h-screen px-6 sm:px-0 bg-gradient-to-br from-[#656d4a] to-[#c2c5aa]'>
        ...
        <form onSubmit={onSubmitHandler } className='bg-[#656d4a] p-8 rounded-lg shadow-lg w-96 text-sm'>
          ...
          <button className='w-full py-3 bg-gradient-to-r from-[#a4ac86] to-[#333d29] text-white rounded-full'>Verify Email</button>
        </form>
